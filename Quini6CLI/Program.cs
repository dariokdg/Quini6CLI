...
namespace Quini6CLI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Player JohnDoe3 = new Player("John Doe3", 20, "Santa Fe", "Arroyo Seco", "San Lorenzo 123", "3402445566", new List<int> { 09, 35, 41, 13, 22, 26 }, Player.GameParticipation.TradicionalAndRevancha);
